        ...
        <div className="w-5xl h-160 bg-blue-500/30 border-2 self-center border-blue-600 p-4 rounded-md">
            ...
            <form className="flex flex-col gap-10 p-4">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input type="text" name="userName" id="userName" className="bg-blue-300/50 p-1 h-10 rounded-md outline-none focus:border-2 focus:border-blue-200  text-white text-[1.2rem]" defaultValue={user.name}/>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input type="text" name="userRa" id="userRa" className="bg-blue-300/50 h-10 rounded-md p-1 outline-none focus:border-2 focus:border-blue-200 text-white text-[1.2rem]" defaultValue={user.ra}/>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input type="email" name="userEmail" id="userEmail" className="bg-blue-300/50 h-10 rounded-md p-1 outline-none focus:border-2 focus:border-blue-200  text-white text-[1.2rem]" defaultValue={user.email}/>
